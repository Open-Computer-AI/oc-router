<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-xl border border-accent/20 bg-gradient-to-r from-accent-muted to-accent-muted/60 p-3"
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="font-semibold text-text">{{ account.name }}</div>
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-emerald-200 bg-gradient-to-br from-emerald-50 to-bg-elevated p-4 dark:border-emerald-800/30 dark:from-emerald-900/10"
          >
          ...
          <div
            class="card border-blue-200 bg-gradient-to-br from-blue-50 to-bg-elevated p-4 dark:border-blue-800/30 dark:from-blue-900/10"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-text-muted">{{
          ...
          <!-- Daily Average Cost -->
          <div
            class="card border-amber-200 bg-gradient-to-br from-amber-50 to-bg-elevated p-4 dark:border-amber-800/30 dark:from-amber-900/10"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-text-muted">{{
          ...
          <div
            class="card border-purple-200 bg-gradient-to-br from-purple-50 to-bg-elevated p-4 dark:border-purple-800/30 dark:from-purple-900/10"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-text-muted">{{
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-text-muted">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-text"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-text-muted">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-text"
    ...
    <template #footer>
      <div class="flex justify-end">
        <button
          @click="handleClose"
          class="rounded-lg bg-muted px-4 py-2 text-sm font-medium text-text transition-colors hover:bg-muted"
        >
          {{ t('common.close') }}
        </button>
      </div>
