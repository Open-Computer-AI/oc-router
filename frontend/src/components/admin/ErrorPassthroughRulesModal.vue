  ...
  >
    <div class="space-y-4">
      ...
      <div v-else-if="rules.length === 0" class="py-8 text-center">
        ...
        <h4 class="mb-1 text-sm font-medium text-text">
      ...
      <div v-else class="max-h-96 overflow-auto rounded-lg border border-border">
        <table class="min-w-full divide-y divide-border">
          ...
          <tbody class="divide-y divide-border bg-bg-elevated">
            <tr v-for="rule in rules" :key="rule.id" class="hover:bg-muted">
              <td class="whitespace-nowrap px-3 py-2">
                <span class="inline-flex h-5 w-5 items-center justify-center rounded bg-muted text-xs font-medium text-text">
                  {{ rule.priority }}
                </span>
              </td>
              <td class="px-3 py-2">
                <div class="font-medium text-text text-sm">{{ rule.name }}</div>
                <div v-if="rule.description" class="mt-0.5 text-xs text-text-muted max-w-xs truncate">
                  {{ rule.description }}
                </div>
              </td>
              <td class="px-3 py-2">
              ...
              <td class="px-3 py-2">
                <div v-if="rule.platforms.length === 0" class="text-xs text-text-muted">
              ...
              <td class="px-3 py-2">
                <button
                  ...
                  :class="[
                    ...
                    rule.enabled ? 'bg-accent' : 'bg-muted'
                  ]"
                >
                  <span
                    :class="[
            ...
            <div class="mt-1 space-y-2">
              ...
              >
                <input
                  ...
                  class="mt-0.5 h-3.5 w-3.5 border-gray-300 text-accent focus:ring-accent"
                />
                <div class="flex-1">
                  <span class="text-xs font-medium text-text">{{ option.label }}</span>
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                <input
                  ...
                  class="h-3.5 w-3.5 rounded border-gray-300 text-accent focus:ring-accent"
                />
                <span class="text-xs text-text">{{ platform.label }}</span>
              </label>
            </div>
