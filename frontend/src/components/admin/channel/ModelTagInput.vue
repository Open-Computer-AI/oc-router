<template>
  <div>
    <!-- Tags display -->
    <div class="flex flex-wrap gap-1.5 rounded-lg border border-border bg-bg-elevated p-2 min-h-[2.5rem]">
      <span
      ...
      >
        ...
        <button
          ...
          class="ml-0.5 rounded-full p-0.5 hover:bg-accent-muted"
        >
          <Icon name="x" size="xs" />
        </button>
      </span>
      <input
        ...
        v-model="inputValue"
        type="text"
        class="flex-1 min-w-[120px] border-none bg-transparent text-sm outline-none placeholder:text-text-dim text-text"
