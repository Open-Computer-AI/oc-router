      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="absolute right-2 top-9 text-text-dim"
          ...
          >
            ...
            >
              <span>{{ u.email }}<span v-if="u.deleted" class="ml-1 text-xs text-text-dim">（{{ t('admin.usage.userDeletedBadge') }}）</span></span>
              <span class="ml-2 text-xs text-text-dim">#{{ u.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="apiKeySearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-text-dim">#{{ k.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="accountSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[220px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-text-dim">#{{ a.id }}</span>
            </button>
          </div>
        </div>
