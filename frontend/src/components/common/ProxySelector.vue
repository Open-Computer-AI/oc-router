      ...
      <div v-if="isOpen" class="select-dropdown">
        ...
        <div class="select-header">
          <div class="select-search">
            <Icon name="search" size="sm" class="text-text-dim" />
            <input
              ref="searchInputRef"
              v-model="searchQuery"
              type="text"
        ...
        <div class="select-options">
          ...
          >
            ...
            <Icon v-if="modelValue === null" name="check" size="sm" class="text-accent" />
          </div>
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-2">
                ...
                <span
                  ...
                  class="inline-flex flex-shrink-0 items-center rounded bg-muted px-1.5 py-0.5 text-xs text-text-muted"
                >
                  {{ proxy.account_count }}
                </span>
                <!-- Test result badges -->
                <template v-if="testResults[proxy.id]">
                  <span
                    ...
                    class="inline-flex flex-shrink-0 items-center gap-1 rounded bg-success/10 px-1.5 py-0.5 text-xs text-success"
                  >
                  ...
                  <span
                    v-else
                    class="inline-flex flex-shrink-0 items-center rounded bg-danger/10 px-1.5 py-0.5 text-xs text-danger"
                  >
...
.select-icon {
  @apply flex-shrink-0 text-text-dim;
}
...
.select-search-input {
  ...
  @apply text-text;
  @apply placeholder:text-text-dim;
  @apply focus:outline-none;
}

.batch-test-btn {
  @apply flex-shrink-0 rounded-lg p-1.5;
  @apply text-text-muted hover:text-success;
...
.test-btn {
  ...
  @apply text-text-dim hover:text-success;
  @apply hover:bg-success/10;
  @apply transition-colors disabled:cursor-not-allowed disabled:opacity-50;
}
