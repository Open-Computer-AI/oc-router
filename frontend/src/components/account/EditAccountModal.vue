    ...
    >
      ...
      >
        <div class="overflow-hidden rounded-lg border border-sky-100 bg-sky-50/60 shadow-sm dark:border-sky-900/50 dark:bg-sky-950/20">
          <div class="flex items-start gap-3 px-4 py-3">
            <div class="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-bg-elevated text-sky-600 shadow-sm ring-1 ring-sky-100 dark:text-sky-300 dark:ring-sky-900/60">
          ...
          <div class="border-t border-sky-100 bg-bg-elevated/70 p-2 dark:border-sky-900/50">
              ...
              <button
                ...
                :class="[
                  ...
                  codexImageGenerationBridgeMode === option.value
                    ...
                    : 'border-transparent bg-transparent text-slate-600 hover:border-border hover:bg-muted dark:text-slate-300'
                ]"
              >
                <span
                  :class="[
                    ...
                    codexImageGenerationBridgeMode === option.value
                      ...
                      : 'border-border text-transparent group-hover:border-border'
                  ]"
                >
      ...
      >
        ...
        <div
          ...
          class="rounded-lg bg-muted px-3 py-2 text-xs text-text"
        >
      ...
      >
        ...
        <div class="rounded-lg bg-muted px-3 py-2 text-xs text-text">
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                autoPause5hDisabled ? 'bg-accent' : 'bg-muted'
              ]"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                autoPause7dDisabled ? 'bg-accent' : 'bg-muted'
              ]"
        ...
        <div v-if="account?.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-not-allowed items-center gap-2 opacity-60">
            <input
              ...
              disabled
              class="h-4 w-4 cursor-not-allowed rounded border-border text-accent focus:ring-accent"
            />
