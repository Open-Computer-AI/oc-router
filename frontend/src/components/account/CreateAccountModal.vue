  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-accent text-white' : 'bg-muted text-text-muted'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-text">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-muted" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-accent text-white' : 'bg-muted text-text-muted'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex rounded-lg bg-muted p-1" data-tour="account-form-platform">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ? 'bg-bg-elevated text-orange-600 shadow-sm dark:text-orange-400'
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-bg-elevated text-green-600 shadow-sm dark:text-green-400'
                : 'text-text-muted hover:text-text'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'gemini'
                ? 'bg-bg-elevated text-blue-600 shadow-sm dark:text-blue-400'
                : 'text-text-muted hover:text-text'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'antigravity'
                ? 'bg-bg-elevated text-purple-600 shadow-sm dark:text-purple-400'
                : 'text-text-muted hover:text-text'
            ]"
          >
      ...
      <div v-if="form.platform === 'anthropic'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3 sm:grid-cols-4" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-text">Vertex</span>
              <span class="text-xs text-text-muted">Service Account</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'openai'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-text">OAuth</span>
              <span class="text-xs text-text-muted">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-text">API Key</span>
              <span class="text-xs text-text-muted">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-text">OAuth</span>
              <span class="text-xs text-text-muted">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-text">API Key</span>
              <span class="text-xs text-text-muted">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ...
                : 'border-border bg-muted hover:border-sky-400 hover:bg-sky-50/60 dark:hover:border-sky-600 dark:hover:bg-sky-900/10'
            ]"
          ...
          >
            ...
            <div
              ...
              class="mt-3 rounded-md border border-sky-200 bg-bg-elevated px-3 py-2 text-xs text-sky-900 dark:border-sky-800/50 dark:text-sky-200"
            >
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-border pt-4">
        ...
        <div>
          ...
          <div v-if="antigravityModelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                />
                <svg class="h-4 w-4 flex-shrink-0 text-text-dim" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            class="mb-3 w-full rounded-lg border-2 border-dashed border-border px-4 py-2 text-text-muted transition-colors hover:border-border hover:text-text"
          >
      ...
      <div v-if="form.platform === 'anthropic' && isOAuthFlow">
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            ...
            />
            <span class="text-sm text-text">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
          ...
          <template v-else>
            ...
            <div v-if="modelMappings.length > 0" class="mb-3 space-y-2">
              ...
              >
                ...
                />
                <svg
                  class="h-4 w-4 flex-shrink-0 text-text-dim"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
        ...
        <div class="border-t border-border pt-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            ...
            <div class="flex flex-wrap gap-1.5">
              ...
              <span v-if="selectedErrorCodes.length === 0" class="text-xs text-text-dim">
      ...
      <div v-if="form.platform === 'anthropic' && accountCategory === 'bedrock'" class="space-y-4">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-accent focus:ring-accent"
              />
              <span class="text-sm text-text">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-accent focus:ring-accent"
              />
              <span class="text-sm text-text">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span class="text-sm text-text">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
      ...
      <div class="border-t border-border pt-4 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-muted px-3 py-1.5 text-xs font-medium text-text-muted transition-colors hover:bg-muted"
            >
              + {{ preset.label }}
            </button>
          </div>
              ...
              <div class="mb-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-text-dim transition-colors hover:text-text disabled:cursor-not-allowed disabled:opacity-40"
                  >
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-border px-4 py-2 text-sm text-text-muted transition-colors hover:border-border hover:text-text"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              interceptWarmupRequests ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                windowCostEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-text-muted">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
          ...
          <div class="mt-4">
            ...
            <p class="mt-1 text-xs text-text-muted mb-2">
              ...
              <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
                ...
                :class="[
                  ...
                  userMsgQueueMode === opt.value
                    ...
                    : 'bg-bg-elevated text-text border-border hover:bg-muted'
                ]">
                {{ opt.label }}
              </button>
            </div>
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-border bg-bg-elevated px-3 py-2 text-sm shadow-sm focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
            >
        ...
        <div class="rounded-lg border border-border p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-accent' : 'bg-muted'
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              openaiPassthroughEnabled ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              codexCLIOnlyEnabled ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
        ...
        >
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              codexCLIOnlyAllowClaudeCodeEnabled ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-accent' : 'bg-muted'
            ]"
          >
            <span
              :class="[
      ...
      <div class="border-t border-border pt-4">
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-muted text-xs text-text-muted hover:bg-muted"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
      ...
      <div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-text-muted">
          ...
          <table class="w-full text-xs">
            ...
            <tbody class="divide-y divide-border">
              <tr>
                ...
                <td class="px-3 py-2 text-text-muted">Free</td>
                <td class="px-3 py-2 text-text-muted">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.limitsFree') }}
                </td>
              </tr>
              <tr>
                <td class="px-3 py-2 text-text"></td>
                <td class="px-3 py-2 text-text-muted">Pro</td>
                <td class="px-3 py-2 text-text-muted">
              ...
              <tr>
                <td class="px-3 py-2 text-text"></td>
                <td class="px-3 py-2 text-text-muted">Ultra</td>
                <td class="px-3 py-2 text-text-muted">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-text-muted">Standard</td>
                <td class="px-3 py-2 text-text-muted">
              ...
              <tr>
                <td class="px-3 py-2 text-text"></td>
                <td class="px-3 py-2 text-text-muted">Enterprise</td>
                <td class="px-3 py-2 text-text-muted">
              ...
              <tr>
                <td class="px-3 py-2 text-text"></td>
                <td class="px-3 py-2 text-text-muted">Paid</td>
                <td class="px-3 py-2 text-text-muted">
