  ...
  <div class="card p-4">
    <div class="mb-4 flex items-center justify-between gap-3">
      ...
      <div class="flex flex-wrap items-center justify-end gap-2">
        ...
        <div v-if="enableRankingView" class="inline-flex rounded-lg bg-muted p-1">
          <button
            type="button"
            class="rounded-md px-2.5 py-1 text-xs font-medium transition-colors"
            :class="
        ...
        <table class="w-full text-xs">
          ...
          <tbody>
            <template v-for="model in displayModelStats" :key="model.model">
              <tr
                class="border-t border-border cursor-pointer transition-colors hover:bg-muted"
              ...
              >
                ...
                <td class="py-1.5 text-right text-warning">
                  ${{ formatCost(model.account_cost) }}
                </td>
                <td class="py-1.5 text-right text-text-dim">
            ...
            >
              <td class="py-1.5">
                <div class="flex min-w-0 items-center gap-2">
                  ...
                  <span
                    class="block max-w-[140px] truncate font-medium text-text"
