      ...
      <table class="min-w-full text-sm">
        ...
        <tbody>
          <tr
            v-for="(row, i) in rows"
            :key="i"
            class="border-t border-border cursor-pointer hover:bg-muted"
          ...
          >
            ...
            <td class="px-4 py-2">
              ...
              <span
                ...
                class="ml-1 inline-flex items-center rounded px-1 py-px text-[10px] font-medium leading-tight bg-muted text-text-muted"
          ...
          <tr v-if="!loading && rows.length === 0">
            <td colspan="8" class="px-4 py-8 text-center text-text-dim">{{ t('usage.errors.empty') }}</td>
          </tr>
        </tbody>
      </table>
    </div>
