        ...
        <div v-if="step === 1" class="space-y-6">
          ...
          <template v-if="setupData">
            <div class="flex justify-center">
              <div class="rounded-lg border border-border p-4 bg-bg-elevated">
            ...
            <div class="text-center">
              ...
              <div class="flex items-center justify-center gap-2">
                <code class="rounded bg-muted px-3 py-2 font-mono text-sm">
                  {{ setupData.secret }}
                </code>
                <button
                  type="button"
                  class="rounded p-1.5 text-text-muted hover:bg-muted"
                  @click="copySecret"
                >
