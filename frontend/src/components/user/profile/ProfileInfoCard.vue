<template>
  <div class="space-y-6">
    <section
      ...
      class="card overflow-hidden border border-accent/20 bg-gradient-to-br from-accent-muted via-bg-elevated to-amber-50/70"
    >
          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                <h2 class="truncate text-2xl font-semibold text-text">
                  {{ displayName }}
                </h2>
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :key="hint.key"
                    class="inline-flex items-center gap-1 rounded-full bg-bg-elevated/80 px-3 py-1 ring-1 ring-accent/20"
                  >
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="rounded-2xl bg-bg-elevated/85 px-4 py-3 shadow-sm ring-1 ring-border"
              >
                <p class="text-xs font-medium uppercase tracking-[0.16em] text-text-dim">
    ...
    <div class="space-y-6">
      <div data-testid="profile-main-column" class="space-y-6">
        <section
          ...
          class="card border border-border bg-bg-elevated/90 p-6"
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div class="rounded-3xl border border-border bg-muted/80 p-5">
              <ProfileAvatarCard
                :user="user"
                embedded
              />
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-2xl border border-border bg-muted/80 px-4 py-3 text-sm text-text-muted"
            >
              <Icon name="link" size="sm" class="mt-0.5 text-text-dim" />
              <span>{{ hint.text }}</span>
            </div>
          </div>
        </section>
