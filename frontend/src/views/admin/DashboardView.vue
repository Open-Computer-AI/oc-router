      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-muted p-2">
                <Icon name="key" size="md" class="text-accent" :stroke-width="2" />
              </div>
              <div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-muted p-2">
                <Icon name="server" size="md" class="text-accent" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-text-muted">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-success-muted p-2">
                <Icon name="userPlus" size="md" class="text-success" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-text-muted">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-muted p-2">
                <Icon name="database" size="md" class="text-accent" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-text-muted">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-muted p-2">
                <Icon name="bolt" size="md" class="text-accent" :stroke-width="2" />
              </div>
              <div class="flex-1">
                <p class="text-xs font-medium text-text-muted">
        ...
        <div class="space-y-6">
          ...
          <div class="card p-4">
            <h3 class="mb-4 text-sm font-semibold font-display text-text">
