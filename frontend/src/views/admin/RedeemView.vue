  ...
  <AppLayout>
    <TablePageLayout>
          ...
          <template #cell-value="{ value, row }">
            <span class="text-sm font-medium text-text">
              ...
              <template v-else-if="row.type === 'subscription'">
                ...
                <span v-if="row.group" class="ml-1 text-xs text-text-muted"
                  >({{ row.group.name }})</span
                >
              </template>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-2">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-muted transition-colors hover:bg-red-50 hover:text-red-600"
              >
      ...
      <template #pagination>
        <div
          ...
          class="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-lg bg-accent-muted p-3"
        >
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
          class="relative z-10 w-full max-w-md rounded-xl bg-bg-elevated p-6 shadow-xl"
        >
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          class="relative z-10 w-full max-w-lg rounded-xl bg-bg-elevated p-6 shadow-xl"
        >
    ...
    <Teleport to="body">
      <div v-if="showResultDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-bg-elevated shadow-xl">
          <!-- Header -->
          <div
          ...
          >
            ...
            <button
              ...
              class="rounded-lg p-1.5 text-text-dim transition-colors hover:bg-muted hover:text-text-muted"
            >
          ...
          <div class="p-5">
            <div class="relative">
              <textarea
                ...
                class="w-full resize-none rounded-lg border border-border bg-bg p-3 font-mono text-sm text-text focus:outline-none"
              ></textarea>
            </div>
          </div>
          <!-- Footer -->
          <div
            class="flex justify-end gap-2 rounded-b-xl border-t border-border bg-bg px-5 py-4"
          >
            <button
...
// 监听类型变化，邀请码类型时自动Settings value 为 0
watch(
  () => generateForm.type,
  (newType) => {
