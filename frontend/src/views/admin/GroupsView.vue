      ...
      <template #table>
        ...
        >
          ...
          <template #cell-account_count="{ row }">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-muted px-1.5 py-0.5 font-medium text-text"
              ...
              <div>
                ...
                <span
                  class="ml-1 font-medium text-text"
          ...
          <template #cell-usage="{ row }">
            <div v-if="usageLoading" class="text-xs text-text-dim">—</div>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-muted transition-colors hover:bg-muted hover:text-purple-600"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-muted transition-colors hover:bg-muted hover:text-orange-600"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-muted transition-colors hover:bg-danger/10 hover:text-danger"
              >
    ...
    >
      ...
      >
        ...
        <div v-if="copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-text-dim transition-colors hover:text-accent"
              />
              <div
              ...
              >
                <div
                  class="rounded-lg bg-gray-900 p-3 text-white shadow-float"
                >
          ...
          >
            <span
              ...
              :key="groupId"
              class="inline-flex items-center gap-1 rounded-full bg-accent-muted px-2.5 py-1 text-xs font-medium text-accent"
            >
              {{
              ...
              <button
                ...
                "
                class="ml-0.5 text-accent hover:text-accent/80"
              >
                <Icon name="x" size="xs" />
              </button>
            </span>
              ...
              >
                ...
                >
                  ...
                  <div class="rounded bg-gray-800 p-2">
                    <p class="text-xs leading-relaxed text-gray-300">
                      <span
                        class="inline-flex items-center gap-1 text-primary-300"
        ...
        <div class="mt-4 border-t pt-4">
          ...
          <div
            v-if="createForm.subscription_type === 'subscription'"
            class="space-y-4 border-l-2 border-accent/30 pl-4"
          >
            <div>
              <label class="input-label">{{
        ...
        <div class="border-t pt-4">
          ...
          <div
            ...
            class="overflow-hidden rounded-lg border border-border bg-bg"
          >
            <div
              v-if="!createModelsListLoading && createModelsListState.items.length > 0"
              class="flex items-center justify-between gap-2 border-b border-border bg-bg px-3 py-2 text-xs"
            >
              <span class="text-text-muted">
              ...
              <div class="flex items-center gap-1.5">
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-accent transition-colors hover:bg-accent-muted"
                ...
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-text-muted transition-colors hover:bg-muted"
            ...
            >
              <p v-if="createModelsListLoading" class="text-xs text-text-muted">
              ...
              <div
                ...
                :key="item.id"
                class="flex items-center gap-2 rounded border border-border bg-bg-elevated px-3 py-2"
              >
                <input
                ...
                />
                <span class="min-w-0 flex-1 break-all text-sm text-text">
                  {{ item.id }}
                </span>
                <button
                  type="button"
                  :disabled="index === 0"
                  class="rounded p-1 text-text-dim hover:bg-muted hover:text-text disabled:opacity-40"
        ...
        >
          <label
            class="block mb-2 font-medium text-text"
          >
          ...
          <div class="mt-2 rounded-lg bg-bg p-3 text-xs text-text">
        ...
        >
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            <div
              class="relative overflow-hidden rounded-xl border border-border bg-bg-elevated shadow-card"
            >
              <div
                class="border-b border-border bg-bg px-4 py-3"
              >
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-xl border border-accent/30 bg-bg-elevated shadow-card"
            >
              <div
                class="border-b border-accent/20 bg-accent-muted px-4 py-3"
              >
              ...
              <div class="p-4 bg-bg">
                <div
                  ...
                  class="flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-accent/30 bg-bg-elevated px-5 py-4 text-sm text-accent transition-colors hover:border-accent/50"
                >
                  <span>{{
                  ...
                  <button
                    ...
                    class="flex items-center gap-1.5 text-sm font-medium text-accent transition-colors hover:text-accent/80"
                  >
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-border bg-bg-elevated p-4 shadow-card transition-all hover:border-accent/30 hover:shadow-md"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-bg focus:bg-bg-elevated"
                          />
                        </div>
                        <div
                          class="hidden md:flex md:justify-center md:pt-7 text-accent/40"
                        >
                          <Icon
                            name="arrowRight"
                            size="sm"
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-lg text-text-dim transition-colors hover:bg-danger/10 hover:text-danger"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-border bg-bg-elevated py-3 text-sm font-medium text-text-muted transition-all hover:border-accent/30 hover:bg-accent-muted hover:text-accent"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
            ...
            >
              <div class="flex items-start gap-3">
                      ...
                      <div
                        v-if="
                          ...
                          accountSearchResults[getCreateRuleSearchKey(rule)]
                            ?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-lg border border-border bg-bg-elevated shadow-float"
                      >
                        <button
                        ...
                        >
                          ...
                          <span class="ml-2 text-xs text-text-dim"
                            >#{{ account.id }}</span
                          >
                        </button>
                      </div>
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-text-dim hover:text-danger transition-colors"
          ...
          <button
            ...
            class="mt-3 flex items-center gap-1.5 text-sm text-accent hover:text-accent/80"
          >
            <Icon name="plus" size="sm" />
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            <div
              class="max-h-64 space-y-2 overflow-y-auto p-2"
            >
              <p v-if="editModelsListLoading" class="text-xs text-text-muted">
                {{ t("admin.groups.modelsList.loading") }}
              </p>
              <p
      ...
      <div class="space-y-4">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-border bg-bg-elevated p-3 transition-shadow hover:shadow-md active:cursor-grabbing"
          >
            ...
            <div class="text-sm text-text-dim">#{{ group.id }}</div>
          </div>
        </VueDraggable>
      </div>
