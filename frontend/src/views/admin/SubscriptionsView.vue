          ...
          <div class="flex flex-1 flex-wrap items-center gap-3">
            ...
            >
              ...
              <button
                ...
                type="button"
                class="absolute right-2 top-1/2 -translate-y-1/2 text-text-dim hover:text-text-muted"
              ...
              <div
                ...
                class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-border bg-bg-elevated shadow-lg"
              >
                <div
                ...
                >
                  <span class="font-medium text-text">{{ user.email }}</span>
                  <span class="ml-2 text-text-muted">#{{ user.id }}</span>
                </button>
              </div>
            </div>
          ...
          <div class="ml-auto flex flex-wrap items-center justify-end gap-3">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-lg border border-border bg-bg-elevated shadow-lg"
              >
                <div class="p-2">
                  <!-- User column mode selection -->
                  <div class="mb-2 border-b border-border pb-2">
                    <div class="px-3 py-1 text-xs font-medium text-text-muted">
        ...
        >
          ...
          <template #cell-expires_at="{ value }">
            <div v-if="value">
              ...
              <div v-if="getDaysRemaining(value) !== null" class="text-xs text-text-muted">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-muted transition-colors hover:bg-blue-50 hover:text-blue-600"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-muted transition-colors hover:bg-warning/10 hover:text-warning disabled:cursor-not-allowed disabled:opacity-50"
              >
        ...
        <div>
          ...
          >
            <template #selected="{ option }">
              ...
              />
              <span v-else class="text-text-dim">{{ t('admin.subscriptions.selectGroup') }}</span>
            </template>
    ...
    >
      ...
      >
        <div class="rounded-lg bg-bg p-4">
          ...
          <p v-if="extendingSubscription.expires_at" class="mt-1 text-sm text-text-muted">
      ...
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-bg-elevated p-6 shadow-2xl">
            <button type="button" class="absolute right-4 top-4 text-text-dim hover:text-text" @click="showGuideModal = false">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
            </button>

            <h2 class="mb-4 text-lg font-bold text-text">{{ t('admin.subscriptions.guide.title') }}</h2>
            <p class="mb-5 text-sm text-text-muted">{{ t('admin.subscriptions.guide.subtitle') }}</p>
            ...
            <div class="mb-5">
              ...
              <ol class="ml-8 list-decimal space-y-1 text-sm text-text-muted">
                ...
                <table class="w-full text-sm">
                  <tbody>
                    <tr v-for="(row, i) in guideActionRows" :key="i" class="border-b border-border last:border-0">
                      <td class="whitespace-nowrap bg-bg px-3 py-2 font-medium text-text">{{ row.action }}</td>
                      <td class="px-3 py-2 text-text-muted">{{ row.desc }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
.usage-label {
  @apply w-10 flex-shrink-0 text-xs font-medium text-text-muted;
}

.usage-amount {
  @apply whitespace-nowrap text-xs tabular-nums text-text-muted;
}
