    ...
    <div class="space-y-6 p-6">
      ...
      <template v-else>
        ...
        <div
          ...
          class="rounded-lg border border-accent/20 bg-accent-muted p-4"
        >
          <div class="flex flex-wrap items-center gap-2">
            ...
            <span
              class="rounded-full bg-bg-elevated px-2.5 py-1 text-xs font-medium text-text-muted shadow-sm ring-1 ring-border"
            >
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-border bg-bg-elevated px-3 py-1 font-mono text-xs text-text transition-colors hover:border-accent hover:text-accent"
          ...
          <div class="space-y-4">
            <div
              class="rounded-lg border border-border bg-bg-elevated"
            >
              <div
              ...
              >
                ...
                <span
                  ...
                  class="rounded-full bg-accent-muted px-2.5 py-1 text-xs font-medium text-accent"
                >
              ...
              <div class="bg-muted p-3">
                <iframe
                  class="h-[36rem] w-full rounded-md border border-border bg-bg-elevated"
                  sandbox=""
                  :srcdoc="previewHtml"
