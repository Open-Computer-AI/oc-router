  ...
  <AppLayout>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-dim transition-colors hover:bg-green-50 hover:text-green-600 dark:hover:bg-green-900/20 dark:hover:text-green-400"
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-dim transition-colors hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-900/20 dark:hover:text-blue-400"
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-dim transition-colors hover:bg-muted hover:text-text"
                :title="t('common.edit')"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-text-dim transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
      ...
      <form id="create-promo-form" @submit.prevent="handleCreate" class="space-y-4">
        <div>
          <label class="input-label">
            {{ t('admin.promo.code') }}
            <span class="ml-1 text-xs font-normal text-text-dim">({{ t('admin.promo.autoGenerate') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-text-dim">({{ t('admin.promo.zeroUnlimited') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-text-dim">({{ t('common.optional') }})</span>
          </label>
          <input
    ...
    >
      <div v-if="usagesLoading" class="flex items-center justify-center py-8">
        <Icon name="refresh" size="lg" class="animate-spin text-text-dim" />
      </div>
      <div v-else-if="usages.length === 0" class="py-8 text-center text-text-muted">
