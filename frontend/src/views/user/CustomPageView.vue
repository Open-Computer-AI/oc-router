      ...
      <div class="card flex-1 min-h-0 overflow-hidden">
        ...
        >
          <div class="max-w-md">
            ...
            >
              <Icon name="link" size="lg" class="text-text-dim" />
            </div>
...
.toc-sidebar {
  @apply flex flex-col h-full border-r border-border bg-muted;
  width: min(240px, 30%);
  min-width: 160px;
  max-width: 280px;
  overflow: hidden;
...
.toc-close-btn {
  @apply p-1 rounded text-text-dim hover:text-text-muted hover:bg-muted transition-colors;
}
...
.toc-item {
  ...
  @apply text-text-muted hover:text-text hover:bg-muted;
}

.toc-item.toc-active {
  @apply text-accent bg-accent-muted font-medium;
}
...
.toc-toggle-btn {
  ...
  @apply bg-bg-elevated border border-border;
  @apply text-text-muted hover:bg-muted;
...
.custom-embed-shell {
  ...
  @apply bg-gradient-to-b from-bg to-bg-elevated;
  @apply p-0;
}

.custom-open-fab {
  @apply absolute right-3 top-3 z-10;
  @apply shadow-sm backdrop-blur supports-[backdrop-filter]:bg-bg-elevated/80;
}
...
.markdown-page-content a { @apply text-accent hover:text-accent underline; }
.markdown-page-content blockquote { @apply border-l-4 border-border pl-4 italic text-text-muted my-4; }
...
.markdown-page-content th { @apply border border-border px-3 py-2 bg-muted font-semibold text-left; }
.markdown-page-content td { @apply border border-border px-3 py-2; }
.markdown-page-content code { @apply bg-muted px-1.5 py-0.5 rounded text-sm font-mono; }
.markdown-page-content pre { @apply bg-gray-900 dark:bg-gray-950 text-gray-100 p-4 rounded-lg overflow-x-auto my-4 relative; }
