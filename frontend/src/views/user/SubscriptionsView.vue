  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <div v-else-if="subscriptions.length === 0" class="card p-12 text-center">
        ...
        >
          <Icon name="creditCard" size="xl" class="text-text-dim" />
        </div>
        <h3 class="font-display mb-2 text-lg font-semibold text-text">
      ...
      <div v-else class="grid gap-6 lg:grid-cols-2">
        <div
          ...
          :key="subscription.id"
          class="overflow-hidden rounded-2xl border bg-bg-elevated"
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p v-if="subscription.group?.description" class="mt-0.5 text-xs text-text-muted">
              ...
              <span
                :class="[
                  ...
                  subscription.status === 'active'
                    ? 'bg-success-muted text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300'
                    : subscription.status === 'expired'
                      ? 'bg-muted text-text-muted'
                      : 'bg-danger-muted text-red-700 dark:bg-red-900/40 dark:text-red-300'
                ]"
              >
