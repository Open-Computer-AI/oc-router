<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-bg to-muted p-4"
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="text-3xl font-bold text-text">{{ t('setup.title') }}</h1>
        <p class="mt-2 text-text-muted">{{ t('setup.description') }}</p>
      </div>
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-accent' : 'bg-muted'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <!-- Step Content -->
      <div class="rounded-2xl bg-bg-elevated p-8 shadow-xl">
        <!-- Step 1: Database -->
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-muted p-4">
              <h3 class="mb-2 text-sm font-medium text-text-muted">
            ...
            <div class="rounded-xl bg-muted p-4">
              ...
              <p class="text-text">{{ formData.admin.email }}</p>
            </div>
          </div>
        </div>
